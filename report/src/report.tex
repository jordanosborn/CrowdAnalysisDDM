...
\begin{subfigure}[t]{.5\textwidth}
  ...
  \caption{}
\end{subfigure}
\caption{The figures above show how the fitted parameters (for a fifth order polynomial) vary as a function of box-size for six different videos. TODO: what they show}
...
TODO: brownian okay, ballistic fit very poor, fits stationary crowds well , fits okay to swimmer like but there is additional structure, 5th order poly fits and parameters dependence on box-size. where to go from here.
