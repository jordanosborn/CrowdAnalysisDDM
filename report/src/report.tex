...
In this section we will show how the fitted parameters for Brownian-like crowds vary with $q$ for a Brownian ISF (equation \ref{eqn:BrownianISF}) fitted at a single-scale.
...
\begin{subfigure}[t]{.5\textwidth}
  ...
  \caption{}
\end{subfigure}
\caption{These figures show $\tau_c$ and its dependence on box-size at a range of $q$ values for the video crowd5 on a log-log scale. The figures show $\tau_c$ increasing as a function of box-size for all values of $q$. A similar functional dependence is seen for footage of other Brownian-like crowds.}
