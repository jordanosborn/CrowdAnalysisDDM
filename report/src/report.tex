...
\\\\
In the figure below we see an outline of how DDM is carried out in the simple case of Brownian Motion. A detailed discussion of the theory behind DDM will occur in section 3.


\begin{figure}[H]
\centering
\includegraphics[height=6cm]{images/ddmpic.png}
...
\item the expected functional form (for Brownian Motion) of this power spectrum has been proven to be $I(q, \tau) = A(q) \cdot (1 - e^{-\tau / \tau_c (q)}) + B(q)$.
\end{enumerate}
\end{figure}
