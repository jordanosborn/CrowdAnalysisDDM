...
\centering
\begin{subfigure}[t]{.47\textwidth}
\includegraphics[width=\linewidth]{images/500colloid_fit.png}
\caption{TODO stuff about why regions are messed up}
...
\begin{subfigure}[t]{.47\textwidth}
  ...
  \caption{After extracting the linear region of the data, linear regression is performed and plotted on top of the data.}
