...
\maketitle
\section*{Abstract}
%TODO: 500 words overview should be about 1/3 the length  summarise key points only
...
%TODO: advantages disadvantages over other techniques
...
%algorithm pipeline	
\centering
\includegraphics[width=0.97\textwidth]{images/algo-pipeline.png}
