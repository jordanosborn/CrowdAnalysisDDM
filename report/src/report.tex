...
% multi and single scale ddm, implementation,  mathematical technique that makes heavy use of fourier transforms, future , curve fitting, algo tested against brownian motion, results, sections
