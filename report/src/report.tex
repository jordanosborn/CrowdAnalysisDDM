...
\begin{tabular}{ |c|c|c|c|c| } 
 \hline
 Type & Gradient & Intercept & R-value & Standard Error \\ 
 \hline
 Geometric Brownian Motion & -1.272 & 6.736 & -0.996 & 0.008 \\ 
 Brownian Motion $\sigma=1$ & -2.016 & 8.364 & -0.997 & 0.023 \\ 
 Brownian Motion $\sigma=5$ & -2.13 & 6.65 & -0.994 & 0.05 \\ 
 \hline
\end{tabular}
